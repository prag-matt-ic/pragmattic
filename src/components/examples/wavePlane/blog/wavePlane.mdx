...
- We update the shader's uScrollProgress uniform inside useFrame. By adding the scrollLoop count we ensure the value passed to the shader never jumps back to 0.
...
I hope that you've found this article useful, and that it's inspired you to dive deeper on your own personal journey.
