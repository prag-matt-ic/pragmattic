...
There will be no scroll unless you <b>set an explicit height on your <code>main</code> element</b>.<br/> 
For example:
...
In order to utilise GSAP ScrollTrigger, we need to <b>register plugins</b> at the top of the component:
