  ...
  return (
    <section id="client-logos" className="absolute bottom-8 flex w-full justify-center sm:bottom-12">
      <div className="grid grid-cols-3 items-center justify-items-center gap-5 px-8 text-xs text-light sm:mt-24 sm:flex sm:text-base md:gap-6">
        ...
        <Image src={bootsLogo} alt="Boots" className="h-6 md:h-8" />
        <Image src={levisLogo} alt="Levis" className="h-6 md:h-8" />
        <Image src={cliniqueLogo} alt="Clinique" className="h-5 md:h-8" />
        <Image src={evianLogo} alt="Evian" className="h-6 md:h-8" />
        <Image src={ballantinesLogo} alt="Ballantines" className="h-6 md:h-8" />
