Let's walk through the necessary setup for working with GLSL shaders in Next.js, React Three Fiber and TypeScript.<br/>
This configuration allows you to use `glslify` and load `.frag`, `.vert`, or `.glsl` files without compile-time errors.<br/>
We'll also cover Typescript inside the React Component.


## 1. Install Dependencies
Add the packages required to load and process GLSL files:

```bash
npm install raw-loader glslify glslify-loader
```

#### [glslify-loader](https://www.npmjs.com/package/glslify-loader)
Loader for Webpack that processes GLSL files using glslify.

#### [glslify](https://github.com/glslify/glslify)
Resolves `#pragma glslify` statements, allowing us to import/export from inside GLSL files.
