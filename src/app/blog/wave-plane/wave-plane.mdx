...
import { RotatedPlaneCanvas, BasicFragmentShaderPlaneCanvas, GradientFragmentShaderPlaneCanvas, GridLinesFragmentShaderPlaneCanvas } from '@/components/examples/wavePlane/blog/WavePlaneBlog'
...
<Aside title='So... what are the packages for?'>
...
- *[glslify-loader](https://www.npmjs.com/package/glslify-loader)*: A webpack loader that integrates glslify<br/>
